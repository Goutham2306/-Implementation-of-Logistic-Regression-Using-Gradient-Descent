...
# Step 1: Load dataset
data = pd.read_csv(r"/content/Placement_Data (2).csv")
...
## Output:
<img width="717" height="321" alt="image" src="https://github.com/user-attachments/assets/c477c4f8-5b93-4c9d-ac6b-5ca288ac5c85" />
